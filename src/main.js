            ...
            try {
                ...
                this._connectionChangedActionHandlerId =
                    ...
                    try {
                        ...
                        console.error(
                            'Error while trying to prompt. This is likely related to getting zone information.'
                        );
                        console.error(e.message);
                        const notification = new Gio.Notification();
                        notification.set_title('Can\'t prompt for firewall zone.');
                        notification.set_body(
                            'There was a problem getting information to prompt for the firewall zone. Please see ' +
